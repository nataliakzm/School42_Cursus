...
/****************************************************************************
	-'parsing' calls the functions to check the map extension, 
		get the map dimensions, allocate memory for the map, 
		store the map in a 2D array, and check the map for errors.
	-'get_map_dimension' gets the map dimensions.
	-'replace_char' replaces the characters in the map with other characters 
		so that the flood-fill algorithm can be performed.
